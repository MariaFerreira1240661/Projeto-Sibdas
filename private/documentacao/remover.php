    ...
    <main class="backend-content">
        ...
        <div class="backend-topbar">
            <div>
                ...
                <p>Confirmação da desativação/arquivo do documento.</p>
            </div>
        ...
        <section class="backend-box text-center">
            ...
            <?php elseif ($registo) : ?>
                ...
                <div class="detalhe-card mt-4 text-start">
                    ...
                    <div class="detalhe-linha">
                        <span>Tipo</span>
                        <strong><?= h($registo->tipo_documento) ?></strong>
                    </div>
                    ...
                    <div class="detalhe-linha">
                        <span>Validade</span>
                        <strong><?= h(data_pt($registo->data_validade)) ?></strong>
                    </div>

                    <div class="detalhe-linha">
                        <span>Estado atual</span>
                        <strong><span class="estado <?= classe_estado_remover($registo->estado_documento) ?>"><?= h($registo->estado_documento) ?></span></strong>
                    </div>
                </div>
